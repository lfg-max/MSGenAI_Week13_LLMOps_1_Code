...
def get_embeddings():
    ...
    Supports separate embedding endpoint if configured.

    Returns:
        AzureOpenAIEmbeddings | OpenAIEmbeddings: Configured embedding model
    """
    # Use separate embedding endpoint if configured
    if Config.AZURE_OPENAI_EMBEDDING_ENDPOINT and Config.AZURE_OPENAI_EMBEDDING_KEY:
